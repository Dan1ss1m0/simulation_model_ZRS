...
environment.add_target('uniform', **dict(id=1, trajectory_arguments=dict(position=(0, 500, 150), velocity=(200, 0, 0))))
environment.add_target('uniform', **dict(id=2, trajectory_arguments=dict(position=(-100, 500, 100), velocity=(200, 0, 0))))
environment.add_target('uniform', **dict(id=3, trajectory_arguments=dict(position=(-200, 0, 200), velocity=(200, 0, 0))))
