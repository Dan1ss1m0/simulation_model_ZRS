...
class Launcher:
    def __init__(self,id: int, launcher_pos: Union[list, tuple, np.ndarray], missile_amount: int, speed: int): # должна быть в public
        ...
        if (self.missile_amount != 0):
            ...
            env.add_projectile('guided missile',
                                       **dict(position=self.launcher_pos.copy(),
                                              ...
                                              explosion_range = 100.0,max_velocity = self.speed))
